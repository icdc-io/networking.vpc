...
export const VPC_ASSIGN_NICS_TO_SECURITY_GROUP = 'VPC_ASSIGN_NICS_TO_SECURITY_GROUP';
...
export const VPC_UNASSIGN_NICS_FROM_SECURITY_GROUP = 'VPC_UNASSIGN_NICS_FROM_SECURITY_GROUP';
